...
class DB{
	...
	public static function connect() {
		try {
			self::$connection = new PDO("pgsql:host=". DATABASE_HOST .";port=". DATABASE_PORT .";dbname=". DATABASE_NAME .";user=". DATABASE_USER .";password=". DATABASE_PASS);
	...
	public static function select($query, $parameters = NULL, $return_class = NULL, $as_array = false) {
